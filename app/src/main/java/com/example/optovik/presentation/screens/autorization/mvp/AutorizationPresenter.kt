...
@InjectViewState
class AutorizationPresenter @Inject constructor(private val router: Router,private val dataManager: DataManager) : BasePresenter<AutorizationView>(router,dataManager) {
